										...
										<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">用户姓名:</label>
												<div class="col-xs-12 col-sm-9">
																<div class="input_control clearfix">
																	...
																	<input type="text"   name="username" id="username" class="col-xs-12 col-sm-6" placeholder="输入用户姓名">
																</div>
													</div>
															...
															<div class="col-xs-12 col-sm-9">
																<div>
																	<label class="line-height-1">
																		<input name="userSex" value="1" type="radio" class="ace">
														...
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
																<div class="clearfix">
																	<input type="text" name="code" id="tcode" class="col-xs-12 col-sm-6"  placeholder="输入登录账号">
																</div>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
																<div class="clearfix">
																	<input type="password" name="userpass" id="userpass" class="col-xs-12 col-sm-4" placeholder="输入密码">
																</div>
															</div>
														</div>
														<div class="space-2"></div>
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
																<div class="clearfix">
																	<input type="password" isProperty="NO" name="confirmuserpass" id="confirmuserpass" class="col-xs-12 col-sm-4" placeholder="输入确认密码">
																</div>
															</div>
														</div>
														<div class="space-2"></div>
														...
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
																<div class="input-group">
																	...
																	<input type="text" id="userTel" name="userTel" placeholder="输入联系方式">
																</div>
															</div>
														</div>
														<div class="space-2"></div>
														...
														<div class="form-group">
															...
															<div class="col-xs-12 col-sm-9">
															  <div id="thelist" class="uploader-list">
																 <img class="nav-user-photo"  id="pic" style="width: 100px;height: 50px;">
																</div> 
															</div>
														</div>
														<div class="form-group">
	 ...
	 $.ajax({
  		 ...
  		 type:"get",
	   		 success:function(data){
	   			   if(data!=null){
	   				  var arr={"id":"-1","pId":"","name":"角色树","open":false};
	   				      data.push(arr);
    ...
    $("#form").validate({
        rules: {
            ...
            code: {
                ...
                remote:{                                          //验证用户名是否存在
                    type:"get",
                    url:webPath+"/user/checkUserCodeIsUse.do",             //servlet
                    data:{
                      code:function(){
    ...
    $('#btn-save').on('click',function(e){
		...
		if(bol){
			...
			var  json=utils.fromToJson(fieldArray);
	    	 utils.confirm('确认提交？',function(){
	    		 $.ajax({
		    		 url:webPath+'/user/save.do',
		    		 type:"post",
